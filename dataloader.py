...
class CustomTokenizer(object):
    ...
    def convert(self, tokens,predicted = True):
        ...
        sentence = []
        for i in tokens:
            if i == self.txt2idx["<pad>"] or i == self.txt2idx["<eos>"] or i == self.txt2idx["<sos>"]:
                continue
            try:
...
class CustomDataset(Dataset):
    def __init__(self, path_list, target_list=None, mode="train"):
        self.sr = 16000
        self.mode = mode
    ...
    def __call__(self, batch):
        ...
        for i in range(len(ids_sorted_decreasing)):
            ...
            text_padded[
                ...
                -100
            )  # https://huggingface.co/transformers/model_doc/wav2vec2.html?highlight=wav2vec2forctc#wav2vec2forctc
